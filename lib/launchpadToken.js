...
async function loadOnChainToken(address) {
  ...
  try {
    ...
    // Retried because a dropped/timed-out call here looks identical to a
    // genuinely empty result — without the retry, one bad RPC round trip
    // is indistinguishable from "this token doesn't exist".
